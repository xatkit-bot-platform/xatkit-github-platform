...
Receive events and performs action on Github from your Xatkit execution model. This platform is bundled with the [Xatkit release](https://github.com/xatkit-bot-platform/xatkit-releases/releases).
...
| -------------------------- | ----- | ------------------ | ------------------------------------------------------------ |
| GithubWebhookEventProvider | Event | -                  | The Github event provider receives webhook events from the Github API and translate them into Xatkit-compatible events. |
